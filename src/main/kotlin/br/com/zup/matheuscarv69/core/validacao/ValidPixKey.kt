 ...
 */
@Singleton
class ValidPixKeyValidator: javax.validation.ConstraintValidator<ValidPixKey, NovaChaveRequest> {

    override fun isValid(value: NovaChaveRequest?, context: javax.validation.ConstraintValidatorContext): Boolean {
 ...
 * - https://docs.jboss.org/hibernate/stable/validator/reference/en-US/html_single/#section-custom-property-paths
 */
class ValidPixKeyValidatorUsingMicronautSupport: ConstraintValidator<ValidPixKey, NovaChaveRequest> {
